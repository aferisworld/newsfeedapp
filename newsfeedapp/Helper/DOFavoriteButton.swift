...
//  Outside Insights
//
//  Created by Nana Kofi Aferi on 11/1/2017.
...
public class DOFavoriteButton: UIButton {
    ...
    private func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(self.touchDown), for: UIControl.Event.touchDown)
        self.addTarget(self, action: #selector(self.touchUpInside), for: UIControl.Event.touchUpInside)
        self.addTarget(self, action: #selector(self.touchDragExit), for: UIControl.Event.touchDragExit)
        self.addTarget(self, action: #selector(self.touchDragEnter), for: UIControl.Event.touchDragEnter)
        self.addTarget(self, action: #selector(self.touchCancel), for: UIControl.Event.touchCancel)
    }
